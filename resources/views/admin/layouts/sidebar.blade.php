        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="{{ request()->is('admin/lomba-it') ? 'active' : '' }} nav-link" href="{{route('admin.lomba_it')}}">Dashboard</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="{{ request()->is('admin/bisnis-tik') ? 'active' : '' }} nav-link" href="{{route('admin.tcp_it')}}">Tahap 1</a></li>
                    <li><a class="{{ request()->is('admin/donatur') ? 'active' : '' }} nav-link" href="">Tahap 2</a></li>
