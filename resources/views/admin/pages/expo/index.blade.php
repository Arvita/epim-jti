                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <button class="d-small btn btn-warning" onclick="openModalInfo({{ $item->id }})"><i class="fa fa-info"></i></button>
                                <button class="d-small btn btn-warning" onclick="openModal('{{$item->status}}', {{$item->id}})"><i class="fa fa-edit"></i></button>
                            </td>
                        </tr>
                          @empty
                          <tr>
            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <p class="w-bold">Nama TIM</p>
                                <p class="nama_tim">Nama TIM</p>
                            </div>
                            <div class="mb-3">
                                <p class="w-bold">Program Studi</p>
                                <p class="prodi">Program Studi</p>
                            </div>
                            <div class="mb-3">
                                <p class="w-bold">Semester</p>
                                <p class="prodi">Semester</p>
                            </div>
                            <div class="mb-3">
                                <p class="w-bold">Semester</p>
                                <p class="prodi">Semester</p>
