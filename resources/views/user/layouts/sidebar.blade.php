        ...
        <ul class="sidebar-menu">
            ...
            <ul class="dropdown-menu">
                <li><a class="{{ request()->is('admin/donasi') ? 'active' : '' }} nav-link"
                        href="{{route('list.donasi')}}">Donasi</a></li>
                <li><a class="{{ request()->is('admin/donatur') ? 'active' : '' }} nav-link"
                        href="{{route('list.donatur')}}">Donatur</a></li>
                <li><a class="{{ request()->is('admin/ajukan-donasi') ? 'active' : '' }} nav-link"
                        href="{{route('list.ajukan-donasi')}}">Ajukan Donasi</a></li>
            </ul>
            <ul class="dropdown-menu">
            ...
            <li><a class="{{ request()->is('admin/ajukan-donasi') ? 'active' : '' }} nav-link" href="#"><i
                        class="fas fa-columns"></i><span>Ajukan Donasi</span></a></li>
            </li>

            <li class="menu-header">Kegiatan</li>
            <li class="{{ request()->is('admin/kegiatan') ? 'active' : '' }}">
                <a href="{{route('list.kegiatan')}}" class="nav-link"><i
                        class="fas fa-fire"></i><span>Kegiatan</span></a>
            </li> --}}
