          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="hero-section col-lg-5 col-sm-12 order-lg-1" data-aos="zoom-in">
                ...
                <p><i>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint debitis quod laborum quis dolores
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 embed-description"  data-aos="fade-left">
            ...
            <p class="desc-1">Lorem ipmsumLorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying
              out print, graphic or web designs. The passage is attributed to an unknown typesetter in the 15th century
        ...
        <div class="row">
          <div class="text-center">
            ...
            <!-- <div class="table-responsive">
              <table class="table table-light table-timeline">
                <thead class="thead thead-proker">
                  <tr>
                    <th>EXPO PRODUK IT</th>
                    <th>LOMBA IT</th>
                    <th>LOMBA TCP IT</th>
                  </tr>
                </thead>
                <tbody class="tbody-proker">
                  <tr>
